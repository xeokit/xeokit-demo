...
import {PlanRadarStoreyView} from "./PlanView.js";
 ...
 *
 * PlanViewPlugin automatically creates its {@link PlanRadarStoreyView}s as {@link MetaModel}s
 ...
 * by default. You can customize the appearance of the Entities by providing your own {@link PlanRadarStoreyViewsPlugin#objectStates}.
 *
 * [[Run this example](https://xeokit.github.io/xeokit-sdk/examples/#gizmos_PlanRadarStoreyViewsPlugin)]
 *
 * ````javascript
 * import {Viewer} from "../src/viewer/Viewer.js";
 * import {GLTFLoaderPlugin} from "../src/viewer/plugins/GLTFLoaderPlugin/GLTFLoaderPlugin.js";
 * import {PlanRadarStoreyViewsPlugin} from "../src/viewer/plugins/PlanRadarStoreyViewsPlugin/PlanRadarStoreyViewsPlugin.js";
 *
 ...
 * });
 *
 * // Add a PlanRadarStoreyViewsPlugin
 * // This will automatically create PlanViews when the model has loaded
 *
 * const planViews = new PlanRadarStoreyViewsPlugin(viewer, {
 *      size: [220, 220],
 *      format: "png",  // Default
 *      ortho: true     // Default
 *  });
 ...
 * ````
 */
class PlanRadarStoreyViewsPlugin extends Plugin {
     ...
     * @param {Object} [cfg.objectStates] Map of visual states for the {@link Entity}s as rendered within each {@link PlanRadarStoreyView}.  Default value is {@link IFCPlanViewObjectStates}.
     * @param {Boolean} [cfg.ortho=true] Whether to capture an orthographic or perspective view for each {@link PlanRadarStoreyView}.
     * @param {Number[]} [cfg.size=[200,200]] Size of {@link PlanRadarStoreyView} images.
     * @param {String} [cfg.format="png"] Format of {@link PlanRadarStoreyView} images. Allowed values are "png" and "jpeg".
     */
    constructor(viewer, cfg = {}) {
        ...
        /**
         * A {@link PlanRadarStoreyView} for each {@link MetaObject} whose {@link MetaObject#type} equals "IfcBuildingStorey", mapped to {@link Entity#id}.
         * @type {{String:PlanRadarStoreyView}}
         */
        this.planViews = {};

        /**
         * A map {@link PlanRadarStoreyView}s for each  {@link MetaModel}.
         * @type {{String:PlanRadarStoreyView}}
         */
        this.modelPlanViews = {};
    ...
    /**
     * Sets map of visual states for the {@link Entity}s as rendered within each {@link PlanRadarStoreyView}.
     *
    ...
    /**
     * Gets map of visual states for the {@link Entity}s as rendered within each {@link PlanRadarStoreyView}.
     *
     * Default value is {@link IFCPlanViewObjectStates}.
     *
     * @type {{String: Object}}
    ...
    /**
     * Sets whether or not to capture an orthographic or perspective view for each {@link PlanRadarStoreyView}.
     *
     * @param ortho
     */
    set ortho(ortho) {
    ...
    /**
     * Gets whether or not to capture an orthographic or perspective view for each {@link PlanRadarStoreyView}.
     *
     * @returns {boolean}
     */
    get ortho() {
    ...
    /**
     * Sets the size of {@link PlanRadarStoreyView} images.
     *
     * Rebuilds {@link PlanRadarStoreyView}s when updated.
     *
     * @param size
     */
    set size(size) {
    ...
    /**
     * Gets the size of {@link PlanRadarStoreyView} images.
     *
     * @returns {*|number[]}
     */
    get size() {
    ...
    /**
     * Sets the format of {@link PlanRadarStoreyView} images. Allowed values are "png" and "jpeg".
     *
     * Rebuilds {@link PlanRadarStoreyView}s when updated.
     *
     * @param format
    ...
    /**
     *
     * Gets the format of {@link PlanRadarStoreyView} images. Allowed values are "png" and "jpeg".
     *
     * @returns {*|number[]}
     */
    get format() {
    ...
    /**
     * Sets the background color of {@link PlanRadarStoreyView} images.
     *
     * Rebuilds {@link PlanRadarStoreyView}s when updated.
     *
     * @param bgColor
    ...
    /**
     * Gets the background color of {@link PlanRadarStoreyView} images.
     *
     * @returns {*|number[]}
     */
    get bgColor() {
    ...
    _buildModelPlanViews(modelId) {
        ...
        // 4. Set canvas size to snapshot size
        ...
        function createNextPlanView() {
            ...
            const planView = new PlanRadarStoreyView(scene.aabb, modelId, storeyObjectId, snapshotData);
    ...
    openOrthoView(storeyObjectId, done) {
        ...
        // Save memento of  object states

        this._sceneState.save(scene);

        // Hide all objects

        scene.setObjectsVisible(viewer.scene.visibleObjectIds, false);

        // With each sub-object of the IfcBuildingStorey
    ...
    closeOrthoView(done) {
        const viewer = this.viewer;
        const scene = viewer.scene;
        this._sceneState.restore(scene);
        if (done) {
            done();
        }
    }
...
export {PlanRadarStoreyViewsPlugin}
